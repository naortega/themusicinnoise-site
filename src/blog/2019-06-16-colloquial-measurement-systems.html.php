...
<p>To understand this, we first have to look at why it's important to have colloquial measurement systems. In our day-to-day lives, we often do not have a frame of reference for units such as meters, grams, or litres, since these are based on objective and verifiable measurements (the size of a meter, for example, is defined as "the length of the path travelled by light in a vacuum in 1 / 299,792,458 of a second"). It is, instead, much easier to measure things based on readily available sizes, such as a foot, or an inch (more or less the distance between the two knuckles of your thumb), etc.</p>

<p>It's also worth noting (as I mentioned before) that this is something common in many countries who have adopted to the Universal Metric System. In Spain it's quite common for handymen to refer to the size of something by how many "fingers" it is (measured by the width of one's finger).</p>

<p>Colloquial measurements are especially helpful in making manual projects (such as wood-working and typical handyman repairs) much more accessible to the masses.</p>
